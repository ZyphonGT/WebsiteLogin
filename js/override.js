$(function(){
    $(".dropdown-approval a").click(function(){
        $("#approvalType").text($(this).text());
        $("#approvalType").val($(this).text());
    });
});

$(function(){
    $(".dropdown-userid a").click(function(){
        $("#useridText").text($(this).text());
        $("#useridText").val($(this).text());
    });
});
